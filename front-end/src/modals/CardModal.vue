        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-container">
                        ...
                        <div class="wrapper description-wrapper">
                            <div class="wrapper-body">
                                ...
                                <div class="descriptioin" v-show="description && !editingDescription" v-html="descriptionHtml"></div>
                            </div>
                        </div>
                        <div class="wrapper attachments-wrapper" v-show="attachments.length || uploadingCount">
                            ...
                            <div class="wrapper-body">
                                <div class="uploading" v-show="uploadingCount"><font-awesome-icon icon="spinner" class="fa-spin"/>Uploading...</div>
                                <ul class="list-unstyled">
                                    <li class="media" v-for="attachment in cardAttachments" v-bind:key="attachment.id">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="when">Added {{ when(attachment.createDate) }} ago</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="wrapper comment-from-wrapper">
                    ...
                    <div class="card-controla">
                        <h5>Add to card</h5>
                        <div class="control"><font-awesome-icon icon="user" class="icon"/> User</div>
                        <div class="control">
                            <uploader 
                                id="cardAttachment"
                                ...
                                @faild="onAttachmentUploadFailed"
...
import autisize from 'autosize'
import showdown from 'showdown'
import notify from '@/utils/noyify'
...
export default {
    ...
    cardActivities() {
        if (!this.member.length || !this.activities.length) {
            return []
        }
    ...
    attachmentUploadUrl() {
        return this.card.id ? '/apu/cards/' + this.card.id + '/attachmentas' : ''
    }
    },
    components: {
        Uploader
