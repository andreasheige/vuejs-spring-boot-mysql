...
describe('services/authentication', () => {
    ...
    it('should vall `/authentications` API', () => {
        expect.assertions(1)
        moxios.wait(() => {
    ...
    it ('should pass the response to caller when request secceded', () => {
        expect.assertions(2)
        moxios.wait(() => {
            let request = moxios.requests.mostRecent()
    ...
    it ('should propagate the error to caller when request faild', () => {
        expect.assertions(2)
        moxios.wait(() => {
            let request = moxios.requests.mostRecent()
            expect(request).toBeTruthy()
